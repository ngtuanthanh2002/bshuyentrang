        ...
        <div className="rounded-2xl bg-primary px-6 py-10 text-center sm:px-10 sm:py-12">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
            {ctaContent.checks.map((check) => (
              <span key={check} className="flex items-center gap-1.5 text-xs text-blue-50 sm:text-sm">
          ...
          <a
            href="#dang-ky"
            className="mt-8 inline-flex cursor-pointer items-center gap-2 rounded-full bg-white px-8 py-3 text-sm font-semibold text-primary transition-colors hover:bg-blue-50"
          >
            {ctaContent.cta}
          ...
          <div className="mt-8 grid gap-3 border-t border-white/15 pt-6 text-left text-sm text-blue-100 sm:grid-cols-2 lg:grid-cols-4">
